...
<body>
	<div class="header">
		...
		<a class="home" href="">Daraga Community College -User </a>
	...
	<div class="wrapper">
		<div class="sidebar">
			...
			<ul>  <!-- put the site links to href="" -->
				...
				<li><a href="template.php"><i class="fas fa-book"></i>Subject Loading</a></li>
				<li><a href="template.php"><i class="fas fa-user-graduate"></i>Library</a></li>
			</ul>
			
		</div>
		<div class="main_content">
			<div class="info" id="User_id">
                <h2>This is Superr Admin</h2
            ></div>
		</div>
	</div>
